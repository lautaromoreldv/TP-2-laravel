                        ...
                        <div class="col-sm-6">
                            <div class="mh-header-info">
                                <div class="mh-promo wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.1s">
                                    <span>{{ $user->excerpt }}</span>
                                </div>
                                <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">{{ $user->name }}</h2>
                                <h3 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">{{ $user->title_job }}</h3>
                                ...
                                <ul>
                                    ...
                                    @if($user->address)
                                        {{ $user->address }}
                                        @else
                                            <span>No disponibble</span>
                                        @endif
                                    </address></li>
                                </ul>
                                
                                <ul class="social-icon wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                    <li><a href="{{ $user->fb }}" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="{{ $user->tw }}" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="{{ $user->gh }}" target="_blank"><i class="fa fa-github"></i></a></li>
                                    <li><a href="{{ $user->db }}" target="_blank"><i class="fa fa-dribbble"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="container">
                <div class="row section-separator">
                        ...
                        <div class="mh-about-img shadow-2 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                            @foreach($user->about as $about)
                                @if($about->image_about)
                                    <img src="{{ $about->get_image }}" alt=""  class="img-fluid {{ $about->titulo }}">
                                    @else
                                    <div class="hero-img wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                        <div class="img-border">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        @foreach($user->about as $about)
                            <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.1s">{{ $about->titulo }}</h2>
                        @endforeach
                            @foreach($user->about as $about)
                            <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">{{ $about->about }}</p>
                            @endforeach
                            ...
                            <a href="{{ $about->cv }}" download="archivo_descargado_desde_tp_2" class="btn btn-fill wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"> {{ $about->boton }} <i class="fa fa-download"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row section-separator">
                        <div class="col-sm-12 col-md-6">
                            <div class="mh-education">
                                <h3 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">{{ $user->edu }}</h3>
